        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SECRETLEVEL = table.Column<byte>(type: "smallint", nullable: false),
                    RETENTIONPERIOD = table.Column<byte>(type: "smallint", nullable: false),
                    FUNDS_CODE = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CUSTODIAN_UNIT = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    STORAGE_LOCATION = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ARCHIVAL_CODE = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ARCHIVAL_CATEGORY = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
